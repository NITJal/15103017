...
public class SocialSite 
{
	public static void main(String args[])throws IOException
	{
		...
		try{
		obj[0].title="Img1";
		obj[0].tag.add("Himakshi");
		obj[0].tag.add("Tushaar");
		obj[0].tag.add("Rikshit");
		obj[1].title="Img2";
		obj[1].tag.add("Manju");
		obj[1].tag.add("Himakshi");
		obj[2].title="Img3";
		obj[2].tag.add("Madan");
		obj[2].tag.add("Manju");
		obj[3].title="Img4";
		obj[3].tag.add("Madan");
		obj[3].tag.add("Tushaar");
		obj[3].tag.add("Rikshit");
		obj[4].title="Img5";
		obj[4].tag.add("Himakshi");
		}
		catch(Exception e)
		{
